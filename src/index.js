...
export const FUNCTIONS = [
    ...
    },
    {
        ...
        syntax: 'BarcodeURL(valueToConvert, barcodeType, width, height, checksumValue, boolShowText, altText, rotation, boolTransparentBG)',
    ...
    },
    {
        ...
        returnType: 'number',
        returnDescription:
            'The requested component of the date as a number (month name is returned as text).',
